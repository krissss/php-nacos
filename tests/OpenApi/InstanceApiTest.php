...
class InstanceApiTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        /*var_dump($this->serviceApi->list((new PageParams())->setPageNo(0)->setPageSize(3)));
        var_dump($this->serviceApi->detail(new ServiceParams($this->serviceName)));
        exit;*/
    ...
    public function testBeat()
    {
        ...
        // 清理
        $this->api->unregister(new InstanceParams('127.0.0.1', '21251', 'not_exist_service'));
        sleep(5);
